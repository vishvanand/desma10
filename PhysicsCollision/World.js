...
var proto = {
	...
	collisionsWith: function (planetObj) { // checks all collisions with a certain player
		for (var i = 0; i < this.planetObjects.length; i++) {
			...
			if (planetObj.collidesWith(this.planetObjects[i])) {


			//	console.log(planetObj); console.log(this.planetObjects[i]); 

				if(this.planetObjects[i].num) 
...
var proto = {
    ...
    onDamage: function () {
    	this.hp--; this.moveInDirection(3); 
    },
